namespace :e2e do
  ...
  task setup: :environment do
    ...
    e2e_component = ready_lib.components.find_or_create_by!(node_id: "e2e:1") do |c|
      ...
      c.figma_json     = {
        "id" => "e2e:1", "type" => "COMPONENT", "name" => "E2EButton",
      ...
      c.react_code_compiled = "function E2EButton(props){return React.createElement('button',null,'Click me');}"
    end
    ...
    e2e_variant = e2e_set.variants.find_or_create_by!(node_id: "e2e:11") do |v|
      ...
      v.react_code_compiled = "function E2ECard(props){return React.createElement('div',null,'Card');}"
    end
